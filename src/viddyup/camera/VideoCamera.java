...
import viddyup.camera.PreviewFrameLayout.OnSizeChangedListener;
...
//            mGripper.setVisibility(View.INVISIBLE);
    ...
    private void showAlert() {
        ...
        if (mCurrentVideoFilename != null) {
            mVideoFrame.setImageBitmap(
                    ThumbnailUtils.createVideoThumbnail(mCurrentVideoFilename, MediaStore.Images.Thumbnails.MICRO_KIND));
    ...
    private void stopVideoRecordingAndShowReview() {
        ...
        if (mThumbController.isUriValid()) {
            ...
            intent.putExtra("viddyup.camera.ReviewMode", true);
            try {
                startActivity(intent);
...
//            mGripper.setVisibility(View.VISIBLE);
    ...
    private void acquireVideoThumb() {
        Bitmap videoFrame = ThumbnailUtils.createVideoThumbnail(mCurrentVideoFilename, MediaStore.Images.Thumbnails.MICRO_KIND);
