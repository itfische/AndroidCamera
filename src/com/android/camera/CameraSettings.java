...
//            SystemProperties.getInt("ro.media.enc.lprof.duration", 60);
    ...
    public CameraSettings(Activity activity, Parameters parameters) {
        ...
        PreferenceManager m = null;
        try {
          m = ((PreferenceActivity) activity).getPreferenceManager();//new PreferenceManager();
        }
        catch (Exception e) {
          // TODO: do something to log that this error occurred, since it almost certainly did
        }
        mManager = m;
